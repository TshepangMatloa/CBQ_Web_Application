<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="CBQ.Login" %>
...
<b style="color:darkred; height:100px; width:100px">Password:</b>
   ...
   width:100%;
    height:40px"/>
         ...
         <p>    
         Don't have an account?<a href ="Register.aspx"> Signup here</a>
             </p>
        </div>
        <div class="col-md-4">
