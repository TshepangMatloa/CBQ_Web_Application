<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Booking_Page.aspx.cs" Inherits="CBQ.Booking_Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        ...
        <div style= "text-align:center; background-color:white" class="col-md-4" <%--style="background-image:url('TshepangVS/FK login BGpic.png'); width:500px"--%>>
            <b><asp:Label ID="lblUser" runat="server" Text="Label" Style="color:maroon; width:200px"></asp:Label></b>
