<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewUser.aspx.cs" Inherits="CBQ.ViewUser" %>
            ...
            <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" class="table"   Font-Size="Small" CellPadding="4" ForeColor="#333333" GridLines="None">
                ...
                <Columns>
                   <asp:TemplateField HeaderText="userID" Visible="False">
                                    <ItemTemplate>
                                        <asp:Label ID="UserID" runat="server" Text='<%# Eval("User_ID")%>' />
                                    </ItemTemplate>
                                    </asp:TemplateField>
                     ...
                     <asp:TemplateField HeaderText="Password" SortExpression="Password">
                        <ItemTemplate>
                            <asp:Label ID="lblTimeCreated" runat="server" Width="200px" Text='<%# Bind("Password") %>'></asp:Label>
                        </ItemTemplate>
                                        </asp:TemplateField>
